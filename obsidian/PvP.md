...
---
*Misfits* is a game about cooperation, but at some point there may be a situation which calls for escalation between players. 
...
- Players are treated as Weavers for the sake of determining sources of threats.  
- Players should still pay costs for Threats they present as if they were actions. This means that action point and mana costs still apply.   
- Attuning/Healing does not present a Threat; it simply happens.   
- Prepared Actions manifest as Prepared Threats, and share the same properties. 
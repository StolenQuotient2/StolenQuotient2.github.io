...
- **Insider**   
	- Choose a Faction. You possess a greater than average knowledge of the workings, plans, and members of that faction. When you take an action to interact with members of this faction, you may reroll your Whim roll before applying Fate. You may take this talent multiple times, but only once for each Faction.   
- **Medicinal**  
	- You understand advanced knowledge of human physiology and have studied Healing Magic. You may cast spells (in the standard way, see \[Spellcasting\]) to restore the injury levels of your companions as an action. The GM will assign a difficulty level for this action based on the level of injury of those you are healing (stronger injuries correspond to more difficult rolls). You may amplify Power to gain 1 Fate for this action.   
- **Runic**
	- You can read, write, speak, and comprehend the language of *Runic*, which underlies magic as a whole, but especially the magic of [Ritualists]({% link obsidian/Ritualist.md %}) and Enchanters. When you take an action to decipher the meaning of runic text, or determine the effect of an ongoing spell or enchantment, you may reroll your Whim roll before applying Fate. 
- Artifice  
...
- Telekinetic  
	- You may produce a small, semi-tangible hand that can manipulate small objects from a distance. Using this ability does not cost an action. The hand is dextrous, but weak. It can manipulate complicated objects such as padlocks, but cannot carry anything more than a pound or two in weight. It is immediately dismissed if it is hit by any object or person. You can only summon one of these at a time, and only for up to 10 minutes at a time. Once dismissed the hand cannot be reproduced for an hour.
- Shieldbearer  
	- You’ve learned to conjure a *Mage’s Shield* as a last line of defense. The shield costs 1 Focus to summon, and acts as a sustained spell effect. The shield protects yourself from physical attacks, and magical attacks from the direction you point the shield in—casters cannot target you with spells directly if the shield is pointed at them. Every time the shield blocks an attack or spell, spend 1 Focus. When you run out of Focus, or choose to dismiss it, the shield breaks.   
- Lashweaver  
